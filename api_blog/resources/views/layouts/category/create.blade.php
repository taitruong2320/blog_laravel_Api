...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">Thêm danh mục bài viết <a href="{{url('/home')}}">Back</a></div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{route('category.store')}}" autocomplete="off" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="short_desc" id="ckeditor_desc" placeholder="Nội dung..." rows="5" class="form-control" style="resize:none" ></textarea>
